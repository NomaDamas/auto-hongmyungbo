...
- Redirect URI: `http://localhost:3000/api/oauth/threads/callback`
...
- Redirect URI: `http://localhost:3000/api/oauth/tiktok/callback`

## 9) Test Flow

1. Start app: `./scripts/start_local.sh`
2. Click OAuth connect button in UI (LinkedIn/X/Reddit/Instagram/Threads/YouTube/TikTok)
