  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4">
      <aside className="relative w-full max-w-md rounded-2xl border border-black/10 bg-white p-5 shadow-xl dark:border-white/10 dark:bg-zinc-900">
        ...
        <label className="mt-3 mb-1 block text-[11px] font-medium uppercase tracking-wide text-zinc-500 dark:text-zinc-400">
          Model
        </label>
        <select
          value={draftModel}
        ...
        <div className="mt-4 rounded-lg border border-zinc-200 p-3 dark:border-zinc-800">
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Reasoning</p>
        ...
        <label className="mt-2 block text-[11px] font-medium uppercase tracking-wide text-zinc-500 dark:text-zinc-400">
          Max output tokens
          <input
            type="number"
            step="1"
        ...
        <div className="mt-4 rounded-lg border border-zinc-200 p-3 dark:border-zinc-800">
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Runtime API keys</p>
          <label className="mb-2 flex items-center gap-2 text-xs text-zinc-700 dark:text-zinc-200">
